...
import { resetUserPasswordAction } from "@/lib/actions/super-admin";
        ...
        {success ? (
          ...
          <div className="space-y-4">
            <p className="text-sm text-zinc-600">
              Choisissez un nouveau mot de passe temporaire pour ce compte.
            </p>
            <Field label="Nouveau mot de passe" htmlFor="newPasswordAdmin" hint="6 caractères minimum">
              <Input
                id="newPasswordAdmin"
                type="text"
                value={password}
