...
import { FactureEngin, type FactureEnginData } from "@/components/sales/FactureEngin";
...
export function FactureEnginView({
  data,
  saleId,
  isCancelled,
  canEdit,
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3 print:hidden">
        <Link href="/vente-engin" className="flex items-center gap-1 text-sm text-zinc-500 hover:text-zinc-700">
          <ArrowLeft className="h-4 w-4" /> Retour à Vente Engin
        </Link>
