  ...
  return (
    <div>
      ...
      <button
        type="button"
        onClick={copyNumber}
        className="mt-2 flex w-full items-center justify-between rounded-lg border border-dashed border-zinc-300 px-3 py-2 text-sm text-zinc-700 hover:bg-zinc-50"
      >
        <span>
