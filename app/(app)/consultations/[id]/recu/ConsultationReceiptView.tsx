...
export function ConsultationReceiptView({ data, defaultWidth }: { data: ReceiptData; defaultWidth: ReceiptWidth }) {
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: `Reçu ${data.ticketNumber}`,
          text: `Voici votre reçu de consultation ${data.ticketNumber}.`,
