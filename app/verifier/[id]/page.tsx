  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-zindo-cream px-5 py-10 sm:px-6">
      <div className="flex flex-col items-center text-center">
        <ZindoLogo size={48} />
        <p className="mt-3 text-sm font-semibold tracking-wide text-zindo-navy-900">
      ...
      <div className="mt-8 w-full max-w-sm">
        {!sale ? (
          <div className="rounded-[24px] border border-red-100 bg-white p-6 text-center shadow-[0_20px_50px_-15px_rgba(13,19,48,0.15)]">
            ...
            <p className="mt-3 font-bold text-zindo-navy-900">Ticket introuvable</p>
          ...
          <div className="rounded-[24px] border border-zindo-navy-900/5 bg-white p-6 shadow-[0_20px_50px_-15px_rgba(13,19,48,0.18)]">
            <div className="flex flex-col items-center text-center">
              {sale.status === "ANNULEE" ? (
                <>
                ...
                <>
                  <CheckCircle2 className="h-10 w-10 text-zindo-green-600" />
                  <p className="mt-3 font-bold text-zindo-navy-900">Ticket authentique</p>
            ...
            <dl className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <dd className="font-medium text-zindo-navy-900">{sale.business.name}</dd>
              </div>
              <div className="flex justify-between">
                <dt className="text-zinc-500">Boutique</dt>
                <dd className="font-medium text-zindo-navy-900">{sale.location.name}</dd>
              </div>
              <div className="flex justify-between">
                <dt className="text-zinc-500">N° de ticket</dt>
                <dd className="font-mono font-medium text-zindo-navy-900">{sale.number}</dd>
              </div>
              <div className="flex justify-between">
                <dt className="text-zinc-500">Date</dt>
                <dd className="font-medium text-zindo-navy-900">{formatDateTime(sale.createdAt)}</dd>
              </div>
              <div className="flex justify-between">
                <dt className="text-zinc-500">Articles</dt>
                <dd className="font-medium text-zindo-navy-900">{sale.items.length}</dd>
              </div>
              <div className="flex justify-between">
                <dt className="text-zinc-500">Paiement</dt>
                <dd className="font-medium text-zindo-navy-900">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-lg font-bold text-zindo-navy-900">
